 ...
 * para mitigar fuerza bruta (Fase 4). Se guarda por `alias` (no por IP: por
...
export const authAttempts = pgTable(
  ...
  (table) => [index("auth_attempts_alias_action_created_at_idx").on(table.alias, table.action, table.createdAt)],
);
